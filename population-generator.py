...
def submit_search():
    #Function for when button for search is submitted
    notification = Label(user_interface, text="Submitted")
    notification.grid()

submit_button = Button(user_interface, text="Click here to submit state and year query", command=submit_search)
